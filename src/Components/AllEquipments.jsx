...
const AllEquipments = () => {
  ...
  return (
    <div className="mx-auto py-6 md:container sm:py-6 md:py-12">
      ...
      {/* header line part  */}
      <div className="mx-auto mb-6 w-11/12 text-center text-black dark:text-white sm:w-10/12 md:w-8/12 lg:w-auto">
      ...
      <div className="mx-auto flex w-11/12 items-center justify-end gap-4 pb-4 md:w-full lg:w-11/12">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <button
            ...
            className="dark:bg-darkPrimary-0 btn h-auto w-max transform rounded-lg bg-primary-0 px-[2px] py-1 text-sm font-semibold text-white hover:bg-primary-0 hover:shadow-lg sm:px-1 md:px-2 md:py-2 md:text-base lg:py-3 lg:text-lg"
          >
      ...
      <div className="grid grid-cols-1 gap-8 px-5 sm:grid-cols-2 sm:gap-4 md:gap-8 lg:grid-cols-3 xl:grid-cols-4">
        {products &&
